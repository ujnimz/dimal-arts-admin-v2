...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    pageImage: Attribute.Media<'images'> & Attribute.Required;
...
export interface ApiContactContact extends Schema.SingleType {
  ...
  attributes: {
    ...
    contactTelephone: Attribute.String & Attribute.Required;
    pageImage: Attribute.Media<'images'> & Attribute.Required;
...
export interface ApiWorkWork extends Schema.SingleType {
  ...
  attributes: {
    ...
    introText: Attribute.RichText;
    posts: Attribute.Relation<'api::work.work', 'oneToMany', 'api::post.post'>;
    seoMeta: Attribute.Component<'seo.seo-meta'>;
    pageWidth: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
